...
// Writes the number of active wathcers to the HTML
	...
	// Defines the main player IDs based on the ID "queue"
	...
	// Provides a visual guide for players to know if they are player 1 or player 2
	...
	msgDatabase.ref('arena').on("child_added", function(snapshot, prevChildKey) {
	  var post = snapshot.val();
	  console.log("arena snapshot: " + post)
	  console.log("last weapon logged: " + post.player);
